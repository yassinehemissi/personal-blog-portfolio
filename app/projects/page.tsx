...
/*
  ...
  {
    id: "1",
    title: "AI-Powered Health Analytics Platform",
    description:
      "A machine learning platform that predicts health outcomes using patient data, combining predictive models with an intuitive dashboard for healthcare providers.",
          ...
          <div className="flex-1 pt-12">
            <div className="space-y-8">
              {filteredProjects.map((project) => (
                <div key={project.id} className="pb-8 border-b border-slate-200 dark:border-slate-800 last:border-b-0">
